...
describe("SIGN UP", () => {
  ...
  it("should be able to deal with data change", () => {
    ...
    userEvent.type(email, "example@gmail.com(opens in new tab)");
    userEvent.type(password, "password");
    expect(firstName.value).toBe("John");
    expect(lastName.value).toBe("Doe");
    expect(email.value).toBe("example@gmail.com(opens in new tab)");
  ...
  it("should show an error when given email already exist", () => {
    ...
    userEvent.type(firstName, "John");
    userEvent.type(lastName, "Doe");
    userEvent.type(email, "abdoulniyigena@gmail.com(opens in new tab)");
    userEvent.type(password, "password");
    form.dispatchEvent(new Event("submit"));
