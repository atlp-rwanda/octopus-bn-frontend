...
import classes from '../styles/dashboardProfile.module.css';
...
class ProfileSettings extends Component {
    ...
    componentDidMount(){
      ...
      const populatedData = decode(token);
      ...
      if(populatedData){
        ...
        user.residence = residence||user.residence || localData.residence
        user.bio = bio||user.bio || localData.bio
        user.passportNumber = passportNumber||user.passportNumber || localData.passportNumber
        user.gender = gender|| user.gender || localData.gender
        user.birthDate = birthDate||user.birthDate || localData.birthDate
        user.preferedLang = preferedLang||user.preferedLang || localData.preferedLang
        user.preferedCurrency = preferedCurrency||user.preferedCurrency || localData.preferedCurrency
        user.department = department||user.department || localData.department
        user.imageUrl = imageUrl||user.imageUrl || localData.imageUrl
        this.setState({ user });
        this.setState({userEmail: email})
        this.setState({lineManagerEmail: localData.managerEmail})
      }
       ...
       render(){
        ...
        <div className={classes.ProfileHolder}>
          ...
          <div className={classes.ProfileRight}>
              ...
              <p><strong>{translate('lineManger')}: </strong>{this.state.lineManagerEmail}</p>
