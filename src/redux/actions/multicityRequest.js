...
export const multiCityAction = (data, history) => async (dispatch) => {
	try {
		...
		const res = await axios.post('https://octopus-bn-backend.herokuapp.com​/api/v1/trips/multi-city', data, header);
